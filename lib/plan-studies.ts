...
export const studyDetails:Record<string,ProjectDetails>={
  "sandplan-meadow-and-landscape": {
    ...
    "intro": "A residential landscape plan begins with the conditions already present: a dry, exposed yard, established trees, productive gardens, and an emerging meadow. The Sandplain Meadow Oasis study connects age-in-place access, family play, shade, and habitat through a site-specific planting strategy.",
